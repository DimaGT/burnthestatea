					...
					triggerSlide.forEach( (el) => {
						...
						el.addEventListener('mousemove', function() {
								...
								if( !gl_canvas.isRunning ) {
									...
									this.className = 'active activeSlide';
						...
						el.addEventListener('mouseout', function() { 
								...
								let isActive = false
								const splitCaptions = document.querySelectorAll('.split-caption');

								splitCaptions.forEach((splitCaption) => {
									const firstChild = splitCaption.firstElementChild;
									if (firstChild && firstChild.classList.contains('activeSlide')) {
										isActive = true
									} 
								});
